...
\section{Glossar}
    ...
    \newglossaryentry{netcdf}{name=NetCDF, description={Das Network Common Data Format (.nc, .cdf) ist ein standardisiertes Dateiformat für den Austausch wissenschaftlicher Daten}}
