...
\begin{enumerate}[label=\textbf{WK\arabic{enumi}0}]
	...
	\item Die Approximation von Clustern führt nicht zu größeren Diskrepanzen oder Wartezeiten %NF ?
	\item Die Erzeugung der grafischen Komponenten erfolgt zeitnah und parallel zur Darstellung der  Benutzeroberfläche selbst %NF?
