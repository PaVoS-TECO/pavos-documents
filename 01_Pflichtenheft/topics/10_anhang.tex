\chapter{Anhang}
    ...
    \newglossaryentry{cluster_shape}{name=Clustershape, description={Eine geometrische Form, die einen bestimmten Raum und darin enthaltene Sensoren überdeckt und durch seine Attribute, beispielsweise Färbung und Transparenz, Sensordaten darstellt}}
    ...
    \newglossaryentry{raster}{name=Raster, description={Eine Aufteilung der Karte in Clustershapes zur besseren Visualisierung}}
    ...
    \newglossaryentry{sensordatentyp}{name=Sensordatentyp, description={Die Art des Messwerts, der durch einen Sensor erfasst wird, beispielsweise Feinstaub, Temperatur, Luftfeuchtigkeit oder Windstärke}}
