\chapter{Anhang}
    ...
    \newglossaryentry{sensortyp}{name=Sensortyp, description={Die Art des Messwerts, der durch einen \glsdisp{sensor}{Sensor} erfasst wird, beispielsweise Feinstaub, Temperatur, Luftfeuchtigkeit oder Windstärke}}
