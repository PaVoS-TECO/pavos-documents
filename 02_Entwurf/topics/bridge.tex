\chapter{Bridge}
\begin{figure}[!hbp]
	\centering\includegraphics[width=\linewidth]{images/bridge/BridgeClassDiagram}
	\caption{Klassendiagramm Bridge}
\end{figure}
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/bridge/classes/JmkbKafkaProducer}
\end{figure}
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/bridge/classes/JmkbMqttConsumer}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/bridge/classes/MessageConverter}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/bridge/classes/PropertiesFileReader}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/bridge/classes/SchemaRegistryConnector}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
