\chapter{Core}
\begin{figure}[!htp]
	\centering\includegraphics[width=1.25\linewidth,angle=90]{images/core/CoreClassDiagram}
	\caption{Klassendiagramm Core}
\end{figure}
...
This Class is a Interface for the Stream Builder Applications which genereates an Output topic to provides data transformations. The ProcessingStrategy will use Kafka DSL API to process the data.\vskip .1in 
\begin{figure}[!htp]
	\centering\includegraphics[width=0.3\linewidth]{images/core/classes/StreamProcessingStrategy}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.9\linewidth]{images/core/classes/Requestor}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.35\linewidth]{images/core/classes/MainFrame}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.3\linewidth]{images/core/classes/ClusterProcessStrategy}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.3\linewidth]{images/core/classes/CombinerProcessStrategy}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.9\linewidth]{images/core/classes/Controller}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.3\linewidth]{images/core/classes/GraphiteProcessStrategy}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.7\linewidth]{images/core/classes/TopologyBuilder}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.3\linewidth]{images/core/classes/UncaughtExceptionHandler}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.6\linewidth]{images/core/classes/PropertiesFileInterface}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!htp]
	\centering\includegraphics[width=0.6\linewidth]{images/core/classes/PropertiesFile}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
