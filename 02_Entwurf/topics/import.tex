...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.4\linewidth]{images/import/classes/DataImporter}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/import/classes/FrostSender}
\end{figure}
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
