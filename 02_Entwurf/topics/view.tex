...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/view/classes/Cluster}
\end{figure} 
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/Dimension}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.5\linewidth]{images/view/classes/Grid}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class Grid
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/Image}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class Image
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/ImageTile}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/ShapeTile}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/Tile}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class Tile
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/AbstractViewFactory}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/View}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class View
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/ViewComponent}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/ViewFactory}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/ViewManager}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.7\linewidth]{images/view/classes/AbstractExportOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/ExportOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/GraphOptionPanelObserver}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.4\linewidth]{images/view/classes/AbstractGraph}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.55\linewidth]{images/view/classes/AbstractGraphOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/GraphDisplayType}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/GraphiteGraph}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/GraphOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\vskip .13in
\hbox{{\bf  Interfaces}}
\entityintro{MapObserver}{View.Map.MapObserver}{An observer that is meant to observe changes in the Map.}
...
An observer that is meant to observe changes in the Map.\vskip .1in 
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/MapObserver}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\subsubsection{Method summary}{
\begin{verse}
\hyperlink{View.Map.MapObserver.mapUpdate()}{{\bf mapUpdate()}} Update the observer with the current Map state.\\
\end{verse}
}
\subsubsection{Methods}{
\vskip -2em
...
Update the observer with the current Map state.
}
\end{itemize}
}%end item
\end{itemize}
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.35\linewidth]{images/view/classes/MapOptionPanelObserver}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.55\linewidth]{images/view/classes/AbstractMap}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.55\linewidth]{images/view/classes/AbstractMapOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.17\linewidth]{images/view/classes/LeafletMap}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.35\linewidth]{images/view/classes/MapLayer}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/MapOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.22\linewidth]{images/view/classes/TileType}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.35\linewidth]{images/view/classes/SensorOptionPanelObserver}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.6\linewidth]{images/view/classes/AbstractSensorOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/ObservedProperty}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.3\linewidth]{images/view/classes/SensorOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/SensorTable}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.35\linewidth]{images/view/classes/TimeOptionPanelObserver}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.55\linewidth]{images/view/classes/AbstractTimeOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.4\linewidth]{images/view/classes/RefreshConfiguration}
\end{figure}  
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/TimeOptionPanel}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.17\linewidth]{images/view/classes/ClusterID}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.15\linewidth]{images/view/classes/Date}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class Date
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.35\linewidth]{images/view/classes/Identifier}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/Point}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
public class Point
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.2\linewidth]{images/view/classes/SensorID}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
...
\begin{figure}[!hbp]
	\centering\includegraphics[width=0.25\linewidth]{images/view/classes/TimeFrame}
\end{figure} 
\subsubsection{Declaration}{
\begin{lstlisting}[frame=none]
